...
class LoanWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Ajouter un emprunt", pos = wx.DefaultPosition, size = wx.Size( -1,160 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.FRAME_FLOAT_ON_PARENT|wx.FRAME_TOOL_WINDOW|wx.SYSTEM_MENU|wx.TAB_TRAVERSAL )
		...
		self.m_staticText1 = wx.StaticText( self, wx.ID_ANY, u"Membre :", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"Livre :", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.end_button = wx.Button( self, wx.ID_ANY, u"Créer l'emprunt", wx.DefaultPosition, wx.DefaultSize, 0 )
