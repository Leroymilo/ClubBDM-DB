...
class MainWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.read_file_picker = wx.FilePickerCtrl( self.inventories, wx.ID_ANY, wx.EmptyString, u"Choisissez un fichier", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE|wx.FLP_SMALL|wx.TAB_TRAVERSAL )
