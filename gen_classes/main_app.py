...
class MainWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.member_archive_toggle = wx.CheckBox( self.members, wx.ID_ANY, u"Afficher inactifs :", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		...
		self.replace_button = wx.Button( self.inventories, wx.ID_ANY, u"Remplacer", wx.DefaultPosition, wx.DefaultSize, 0 )
		inv_h_sizer_2.Add( self.replace_button, 0, wx.ALL, 5 )

		self.append_button = wx.Button( self.inventories, wx.ID_ANY, u"Ajouter", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.write_txt = wx.TextCtrl( self.inventories, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		in_h_sizer_3.Add( self.write_txt, 0, wx.ALL, 5 )


		inv_v_sizer.Add( in_h_sizer_3, 0, wx.EXPAND, 5 )

		self.gen_inv_button = wx.Button( self.inventories, wx.ID_ANY, u"Générer", wx.DefaultPosition, wx.DefaultSize, 0 )
