...
class MemberWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Ajouter un membre", pos = wx.DefaultPosition, size = wx.Size( 450,240 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.FRAME_FLOAT_ON_PARENT|wx.FRAME_TOOL_WINDOW|wx.SYSTEM_MENU|wx.TAB_TRAVERSAL )
		...
		self.m_staticText1 = wx.StaticText( self.global_panel, wx.ID_ANY, u"Nom/Prénom :", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText21 = wx.StaticText( self.global_panel, wx.ID_ANY, u"Mail :", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText21.Wrap( -1 )

		h_sizer_2.Add( self.m_staticText21, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.mail_txt = wx.TextCtrl( self.global_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		h_sizer_2.Add( self.mail_txt, 1, wx.ALL, 5 )

		self.m_staticline = wx.StaticLine( self.global_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_VERTICAL )
		h_sizer_2.Add( self.m_staticline, 0, wx.EXPAND |wx.ALL, 5 )

		self.m_staticText22 = wx.StaticText( self.global_panel, wx.ID_ANY, u"Tel :", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText22.Wrap( -1 )

		h_sizer_2.Add( self.m_staticText22, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.tel_txt = wx.TextCtrl( self.global_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText31 = wx.StaticText( self.global_panel, wx.ID_ANY, u"Statut BDM :", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText41 = wx.StaticText( self.global_panel, wx.ID_ANY, u"Caution :", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText7 = wx.StaticText( self.global_panel, wx.ID_ANY, u"Commentaires :", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText7.Wrap( -1 )

		h_sizer_5.Add( self.m_staticText7, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

		self.comment_txt = wx.TextCtrl( self.global_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		h_sizer_5.Add( self.comment_txt, 1, wx.ALL, 5 )


		v_sizer.Add( h_sizer_5, 0, wx.EXPAND, 5 )

		self.end_button = wx.Button( self.global_panel, wx.ID_ANY, u"Ajouter le membre", wx.DefaultPosition, wx.DefaultSize, 0 )
